...
Fork the project [on GitHub](https://github.com/michaelmior/rack-thor) and check out your
copy locally.

```text
$ git clone git@github.com:username/rack-thor.git
$ cd rack-thor
$ git remote add upstream git://github.com/michaelmior/rack-thor.git
```
...
Go to `https://github.com/yourusername/rack-thor` and select your feature branch.
